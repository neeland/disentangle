...
###################################################################################################################
    ...
    parser.add_argument('--jeffreys', default=False, type=str2bool, help='use jeffreys prior; overides capacity controll, jenshann')
    parser.add_argument('--jenshann', default=False, type=str2bool, help='use jensen-shannon divergence; overides capacity controll, jeffreys -- highest')
