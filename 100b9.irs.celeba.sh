#!/bin/bash
#SBATCH --job-name=100b9.irs.celeba
#SBATCH --output=/home-mscluster/npather/disentangle/logs/100b9.irs.celeba.%A_%a.txt
#SBATCH --partition=batch
#SBATCH --array=0
python3 main.py \
--aicrowd_challenge=false \
--name=100b9.irs.celeba \
--alg=BetaVAE \
--traverse_z=true \
--traverse_c=true \
