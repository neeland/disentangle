#!/bin/bash
#SBATCH --job-name=100c50
#SBATCH --output=/home-mscluster/npather/disentangle/100c50.%A_%a.txt
...
--traverse_z=true \
--traverse_c=true \
--dset_dir=/home-mscluster/npather/disentanglement-pytorch/data/dsprite \
--dset_name=smallnorb \
...
--loss_txt=false \
--wandb_project_name=dsprite_full \
--qma_alpha=0.001 \
--boltzmann_lambda=15 \
--jeffreys=false \
